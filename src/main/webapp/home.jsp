...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header">
        <div class="layui-logo"><img src="assets/images/logo.png"/>EasyWeb</div>
        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                <a href="javascript:;">
                    <img id="userHead" src="assets/images/head.jpg" class="layui-nav-img"><span
                        id="userNickName"></span>
                </a>
                <dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:myInfo();"><i class="layui-icon">&#xe612;</i>&emsp;个人信息</a>
                    </dd>
                    <dd>
                        <a href="javascript:updatePsw();"><i class="layui-icon">&#xe631;</i>&emsp;修改密码</a>
                    </dd>
                    <dd>
    ...
    <div class="layui-footer">
        Copyright © 2018 EasyWeb All rights reserved.
    </div>
    <!-- 手机屏幕遮罩层 -->
    ...
    <form id="pswForm" class="layui-form model-form" action="" method="put">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="oldPsw" placeholder="请输入旧密码" type="password" class="layui-input" maxlength="12"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="newPsw" placeholder="请输入新密码" type="password" class="layui-input" maxlength="12"
                       lay-verify="required|pass" required/>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="newPsw2" placeholder="请再次输入新密码" type="password" class="layui-input" maxlength="12"
                       lay-verify="required|psw2" required/>
            </div>
        </div>
